...
- Compile within a Qemu instance using a user-define executable script.
...
- Score based on the value of a specific location in the memory.
...
*Note:* We are developing a *vulnerability configurator* option. Hopefully, this will be included in the first Beta release in the end of January 2020. This would allow users to configure the tests selection using more abstract concepts than the inconvenient CWEs representation.