...
in mkShell {
  ...
  BESSPIN_TESTGEN_FREEBSD_IMAGE_QEMU = besspin.config.customize.freebsd-image-qemu or
    besspin.testgenFreebsdImageQemu;
  BESSPIN_TESTGEN_FREEBSD_IMAGE = besspin.config.customize.freebsd-image or
    besspin.testgenFreebsdImage;
